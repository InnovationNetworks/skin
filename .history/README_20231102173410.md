...
SKIN has been used in numerous projects, either in its original form or modified to suit the application.  Some of the variations can be found in this repository.  A bibliography of works that used using, derived from or related to SKIN is also included.
