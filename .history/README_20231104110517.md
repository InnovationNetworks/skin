...
SKIN is written using [NetLogo](https://ccl.northwestern.edu/netlogo/index.shtml). The latest version of the [basic SKIN code (v5.32)](https://github.com/InnovationNetworks/skin/blob/master/skin.nlogo) will run using version [NetLogo 6.3.0](https://ccl.northwestern.edu/netlogo/download.shtml).
