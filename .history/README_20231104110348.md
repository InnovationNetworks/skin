...
SKIN is written using [NetLogo](https://ccl.northwestern.edu/netlogo/index.shtml). The latest version (v5.32) will run using version [NetLogo 6.3.0](https://ccl.northwestern.edu/netlogo/download.shtml).
